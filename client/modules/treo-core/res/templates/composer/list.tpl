                ...
                <div class="module-list-container">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">
                                <span style="cursor: pointer;" class="action panel-title-text" title="{{translate 'clickToRefresh' category='messages'}}" data-action="refresh" data-collection="installed">{{translate 'Installed' scope='Composer' category='labels'}}</span>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">
                                <span style="cursor: pointer;" class="action panel-title-text" title="{{translate 'clickToRefresh' category='messages'}}" data-action="refresh" data-collection="store">{{translate 'Store' scope='Composer' category='labels'}}</span>
                            </h4>
                        </div>
                        <div class="panel-body">
...
<style>
    ...
    .module-list-container > .panel > .panel-body {
        padding: 0;
    }
