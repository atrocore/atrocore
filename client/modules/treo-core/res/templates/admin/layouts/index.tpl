<div class="page-header"><h3><a href="#Admin">{{translate 'Administration'}}</a><span class="subsection">{{translate 'Customization' scope='Admin'}}</span>{{translate 'Layout Manager' scope='Admin'}}</h3></div>
