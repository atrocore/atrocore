<div class="page-header"><h3><a href="#Admin">{{translate 'Administration'}}</a><span class="subsection">{{translate 'System'}}</span>{{translate 'Integrations' scope='Admin'}}</h3></div>
