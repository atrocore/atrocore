...
Espo.define('views/admin/field-manager/fields/linkMultiple/extensible-multi-enum-default', 'treo-core:views/fields/filtered-link-multiple', Dep => {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:extensibleEnumId', () => {
                this.model.set('defaultIds', null);
                this.model.set('defaultNames', null);
                this.reRender();
            });
        },
            ...
            if (this.model.get('defaultIds')) {
                this.ajaxGetRequest(`${this.foreignScope}`, {
                    where: [{
                        type: "in",
                        attribute: "id",
                        value: this.model.get('defaultIds')
                    }]
                }).success(res => {
                    let defaultNames = {};
                    if (res.list) {
                    ...
                    this.model.set('defaultNames', defaultNames);
                });
            }
        },
