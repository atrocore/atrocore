    ...
    Dep => Dep.extend({
        ...
        data() {
            return {
                ...
                hasIcon: !this.model.get('mediumThumbnailUrl') && !(this.getMetadata().get('app.file.image.extensions') || []).includes(this.model.get('extension')),
                extension: this.model.get('extension'),
                name: this.getModelTitle(this.model),
