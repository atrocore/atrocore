...
Espo.define('views/fields/combined-float', ['views/fields/base', 'views/fields/combined-varchar'], (Dep, Varchar) => {
    ...
    return Dep.extend({
        ...
        afterRender() {
            ...
            const value = (rawValue === null || rawValue === undefined || isNaN(rawValue)) ? null : Number(rawValue);

            this.svelteComponent = new Svelte.CombinedFloatField({
                target,
                props: {
