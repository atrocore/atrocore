<ul class="footer-links hidden">
    ...
    <li style="padding-top: 10px">
        <span>&copy;<span class="year">{{year}}</span> <a href="https://atrocore.com" title="AtroCore / EspoCRM" target="_blank">AtroCore is based on EspoCRM</a></span>
    </li>
</ul>
<div class="copyright">
    <span>AtroСore: {{version}}</span>
