<div class="additional-panel">
    <div class="row">
        <div class="cell col-sm-6 form-group" data-name="mode">
    ...
    <div class="row">
        <div class="cell col-sm-6 form-group" data-name="width">
            <label class="control-label" data-name="width">
        ...
        <div class="cell col-sm-6 form-group" data-name="height">
