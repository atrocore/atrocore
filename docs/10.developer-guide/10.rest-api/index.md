...
> For more complex queries and a full list of supported operators, consult the [Advanced data querying](../02.understanding-atrocore/10.select-manager/index.md) section in the documentation.
