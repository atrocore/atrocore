...
For more comprehensive information on LayoutProfiles, refer to the [Layouts Administration](../../../01.atrocore/03.administration/13.user-interface/02.layouts/docs.md) documentation.
