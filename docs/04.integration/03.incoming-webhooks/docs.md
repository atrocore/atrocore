...
> For import purposes, [Import Feeds](../../03.data-exchange/01.import-feeds/) provide dedicated import configuration options and are specifically designed for data import workflows
