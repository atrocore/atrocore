...
For example, all tables that store various logs, such as `ActionHistoryRecord` (represents [Archive](../../02.atrocore/03.administration/11.entity-management/01.entity-types/docs.md#archive) type entity `Action History`), can transfer their data to ClickHouse. This process is seamless for the user:
