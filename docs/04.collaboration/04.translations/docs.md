...
If the Quality Check module is installed in your instance, you can monitor the percentage of translated/approved multilingual fields for each record using the ["Translation Completeness"](../../01.atrocore/15.data-quality/docs.md#translation-completeness) quality check.
