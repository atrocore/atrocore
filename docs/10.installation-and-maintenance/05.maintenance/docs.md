...
> If database rebuild is required, the `Rebuild Database` option will also be shown in the [User menu](../../02.atrocore/05.toolbar/docs.md#user-menu) for admin users.
...
> The `Clear System cache` option is also available in the [User menu](../../02.atrocore/05.toolbar/docs.md#user-menu) for admin users.
