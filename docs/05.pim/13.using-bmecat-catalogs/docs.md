...
**Catalog** – a container for your [products](../03.products/) arranged by certain criteria, i.e. it is a set of data at a given time compiled to be transferred via certain [channels](../06.channels/). Catalog's content may be modified whenever needed within the [AtroPIM system](../../01.atrocore/02.getting-started).
...
The new record will be added to the catalogs list. You can configure it right away on the [detail view](../../01.atrocore/04.understanding-ui/docs.md#detail-view) page that opens or return to it later.

Alternatively, use the [quick create](../../01.atrocore/04.understanding-ui#quick-create) button on any AtroPIM page and fill in the required fields in the catalog creation pop-up that appears:
...
By default, the following fields are displayed on the [list view](../../01.atrocore/04.understanding-ui#list-view) page for catalog records:
...
Catalog records can be searched and filtered according to your needs. For details on the search and filtering options, refer to the [**Search and Filtering**](../../01.atrocore/11.search-and-filtering) article in this user guide.

To view some catalog record details, click the name field value of the corresponding record in the list of catalogs; the [detail view](../../01.atrocore/04.understanding-ui#detail-view) page will open showing the catalog records and the records of the related entities. Alternatively, use the `View` option from the single record actions menu to open the [quick detail](../../01.atrocore/04.understanding-ui#quick-detail-view-small-detail-view) pop-up.
...
For details on these actions, refer to the [**Mass Actions**](../../01.atrocore/04.understanding-ui#mass-actions) section of the **Views and Panels** article in this user guide.
...
For details on these actions, please, refer to the [**Single Record Actions**](../../01.atrocore/04.understanding-ui#single-record-actions) section of the **Views and Panels** article in this user guide..

## Editing

To edit the catalog, click the `Edit` button on the [detail view](../../01.atrocore/04.understanding-ui#detail-view) page of the currently open catalog record; the following editing window will open:

![Catalog Editing](./_assets/catalog-edit.jpg){.large}

Here edit the desired fields and click the `Save` button to apply your changes.

Besides, you can make changes in the catalog record via [in-line editing](../../01.atrocore/04.understanding-ui#in-line-editing) on its detail view page.
...
Alternatively, make changes to the desired catalog record in the [quick edit](../../01.atrocore/04.understanding-ui#quick-edit-view) pop-up that appears when you select the `Edit` option from the single record actions menu on the catalogs list view page:
...
Relations to [categories](../05.categories/) and [products](../03.products/) are available for all catalog records by default. The related entities records are displayed on the corresponding panels on the catalog [detail view](../../01.atrocore/04.understanding-ui#detail-view) page. If any panel is missing, please, contact your administrator as to your access rights configuration.
...
Then the "Products" page opens, where all product records [filtered](../../01.atrocore/11.search-and-filtering) by the given catalog are displayed:

![Products full list](./_assets/products-full-list.jpg){.large}

To view the catalog related product, click its name in the products list. The [detail view](../../01.atrocore/04.understanding-ui#detail-view) page of the given product will open, where you can perform further actions according to your access rights, configured by the administrator.
