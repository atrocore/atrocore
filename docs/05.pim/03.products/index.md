...
By default, the following fields are displayed on the [list view](../../01.atrocore/04.understanding-ui/index.md#list-view) page for product records:
 - Number
 - Main Image
 - Name
 - Brand
...
The Products entity supports all standard system [filters](../../01.atrocore/11.search-and-filtering/index.md) and also provides a set of product-specific filters designed to simplify product data management and quality control.
...
Products is a [Hierarchy](../../01.atrocore/03.administration/11.entity-management/01.entity-types/index.md#hierarchy) entity type. This means that product records can be organized in a parent–child structure, enabling inheritance of values and properties from parent products to their child products.
...
This panel displays the parent product of the current product. If the [Multiple Parents](../../01.atrocore/03.administration/11.entity-management/04.hierarchies-and-inheritance/index.md#core-hierarchy-settings) option is enabled in the entity configuration, the panel may display more than one parent product.
...
They all are displayed on the corresponding panels on the product record [detail view](../../01.atrocore/04.understanding-ui/index.md#detail-view) page. If any panel is missing, please, contact your administrator as to your access rights configuration.
...
Product attribute records are displayed on the `Attributes` panel within the product record [detail view](../../01.atrocore/04.understanding-ui/index.md#detail-view) page and are grouped by attribute groups. 
...
For more information about attributes go to [attributes](../../01.atrocore/03.administration/12.attribute-management/01.attributes/index.md) page.
...
Products that are linked to the currently open product record through the [association](../../01.atrocore/03.administration/11.entity-management/08.associations/), are displayed on its [detail view](../../01.atrocore/04.understanding-ui/index.md#detail-view) page on the `Associated Items` panel.
...
Products to which the currently open product record is linked to through the [association](../../01.atrocore/03.administration/11.entity-management/08.associations/), are displayed on its [detail view](../../01.atrocore/04.understanding-ui/index.md#detail-view) page on the `Associating Items` panel.
...
Files that are linked to the currently open product record are displayed on its [detail view](../../01.atrocore/04.understanding-ui/index.md#detail-view) page on the `Files` panel and include the following table columns:
- Preview
- Name
- Type
- File Size (bytes)
...
From this option users can upload files in the same manner as on [files](../../01.atrocore/13.file-operations/index.md#create-a-file-using-the-upload-button) page and uploaded files will be automatically linked to current product.
...
For quick navigation to products we also recommend using [dashboards](../../01.atrocore/07.dashboards/index.md). All summarized information about your products can be viewed here. The information according to built-in filters is displayed on dashlets.
