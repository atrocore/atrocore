...
Schedule regular imports via [Scheduled Jobs](../../02.atrocore/03.administration/05.system-jobs/01.scheduled-jobs/) to keep your AtroCore data synchronized automatically, ensuring your system always has the latest information without manual intervention. 
...
- **Connection** – select or create a [Connection](../../02.atrocore/03.administration/04.connections/) of the required type: [MySQL](../../02.atrocore/03.administration/04.connections/docs.md#mysql-server), [PostgreSQL](../../02.atrocore/03.administration/04.connections/docs.md#postgresql-server), or [MSSQL](../../02.atrocore/03.administration/04.connections/docs.md#microsoft-sql-server). [PDO SQL](../../02.atrocore/03.administration/04.connections/docs.md#pdo-sql) connections are also available.
