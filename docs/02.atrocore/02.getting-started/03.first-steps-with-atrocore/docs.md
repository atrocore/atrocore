...
For more information on data import, get familiar with the detailed article [Import Feeds](../../../03.data-exchange/01.import-feeds/).
...
You may also need to configure separate rules for assets and main images. [Read more on the import of related assets here.](../../../03.data-exchange/01.import-feeds/docs.md#related-files-fields-and-attributes-of-type-file)
