...
Clusters are created automatically by a [scheduled job](../../../02.atrocore/03.administration/05.system-jobs/01.scheduled-jobs/docs.md#create-clusters) based on the Matching Rules configured for the entity. Users cannot create clusters manually, nor can they add or remove cluster items manually.
...
If automatic [field locking](../../../02.atrocore/03.administration/11.entity-management/06.advanced-data-management/docs.md#field-value-lock) on manual modification is enabled, updates from staging records will not overwrite fields in the master record that have been modified manually.
