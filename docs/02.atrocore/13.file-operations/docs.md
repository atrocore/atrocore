...
The [ExportFeed](../../03.data-exchange/02.export-feeds/docs.md), [ExportJob](../../03.data-exchange/02.export-feeds/docs.md#export-executions), [ImportFeed](../../03.data-exchange/01.import-feeds/docs.md), [ImportJob](../../03.data-exchange/01.import-feeds/docs.md#import-executions), and [PDFFeed](../../08.publishing/01.pdf-generator/docs.md#pdf-feeds) fields establish bidirectional relationships between files and export/import operations. These fields are read-only and are not shown on layouts by default. When viewing a file record, you can see which export or import feed and execution created it. For export-generated files, this corresponds to the `Exported File` field on the related [Export Execution](../../03.data-exchange/02.export-feeds/docs.md#export-executions) record; for import-generated files, it corresponds to the `Imported File` field on the related [Import Execution](../../03.data-exchange/01.import-feeds/docs.md#import-executions) record. Conversely, you can filter files in the File entity by these fields to find all files created by a specific export or import operation.
