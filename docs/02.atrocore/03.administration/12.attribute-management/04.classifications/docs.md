...
Relations to [attributes](../01.attributes/) and [products](../../../../06.pim/03.products/) are available for all Classifications by default. The related entities records are displayed on the corresponding panels on the Classification [detail view](../../../04.understanding-ui/docs.md#detail-view) page. If any panel is missing, please, contact your administrator as to your access rights configuration.
