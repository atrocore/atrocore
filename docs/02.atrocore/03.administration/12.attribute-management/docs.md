...
Attributes can be added to [Products](../../../06.pim/03.products/docs.md) and any other entity within the system. By default, attributes are enabled for Products. To use attributes with other entities, you must activate the "Has Attributes" option in the [Entity Manager](../11.entity-management/docs.md).
