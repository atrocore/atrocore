...
-   **Body** - The content of the notification using [Twig](../../../11.developer-guide/80.twig-tutorial/) template syntax.
...
-   **Subject** - The email subject line using [Twig](../../../11.developer-guide/80.twig-tutorial/) template syntax
-   **HTML** - Set the checkbox if you want your content to have HTML formatting
-   **Body** - The content of the email using [Twig](../../../11.developer-guide/80.twig-tutorial/) template syntax.
