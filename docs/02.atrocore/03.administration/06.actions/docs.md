...
Actions in AtroCore are automated operations that can be executed manually through the user interface or automatically via [scheduled jobs](../05.system-jobs/01.scheduled-jobs/) and [workflows](../../../05.collaboration/01.workflows/). They provide a powerful framework for automating business processes, data transformations, integrations, and AI-powered operations.
...
- **Data Integration**: Seamless integration with [import feeds](../../../03.data-exchange/01.import-feeds/) and [export feeds](../../../03.data-exchange/02.export-feeds/)
...
- **Conditions Type**: How conditions are evaluated:
  ...
  - **Script**: Custom script conditions following [Twig syntax](../../../11.developer-guide/80.twig-tutorial/docs.md)
...
- Support for [Twig](../../../11.developer-guide/80.twig-tutorial/) templating syntax using `{{ entity.fieldName }}` expressions
...
- **[Workflows](../../../05.collaboration/01.workflows/)**: Event-driven execution based on entity changes
...
> More detailed information for Import and Export actions can be found in the related Feed documentation, such as [Import Feed](../../../03.data-exchange/01.import-feeds/docs.md#import-executions) and [Export Feed](../../../03.data-exchange/02.export-feeds/docs.md#export-executions).
...
#### **Upsert**
> Available with [Workflow](../../../05.collaboration/01.workflows/docs.md) module.
...
#### **Create Version**
> Available with [Revisions](../../../05.collaboration/03.revisions/docs.md) module.
...
> Versioning must be [enabled](../../../05.collaboration/03.revisions/docs.md#enabling-versioning) for the source entity.
...
> Change Requests must be [enabled](../../../05.collaboration/03.revisions/docs.md#enabling-change-request) for the source entity.
...
#### **Suggest value by AI**
> Available with [AI Integration](../../../06.pim/11.ai-integration/docs.md) module.

It uses the same method as **Suggest value** action type but uses AI for the suggested data. For implementation details and usage, refer to the [AI Integration documentation](../../../06.pim/11.ai-integration/docs.md#updating-values-in-frontend).

#### **Set value by AI**
> Available with [AI Integration](../../../06.pim/11.ai-integration/docs.md) module.

It uses the same method as **Update** action type but uses AI for the suggested data.For related behavior and configuration, see the [AI Integration documentation](../../../06.pim/11.ai-integration/docs.md#updating-values-in-backend).
...
> While this action type can organize outgoing webhook calls, consider using [Export Feeds](../../../04.integration/04.outgoing-webhooks/) instead for more flexible and powerful outbound HTTP integration.
...
- **Payload**: Custom data payload for the import with [Twig](../../../11.developer-guide/80.twig-tutorial/) templating syntax
...
- **Payload**: Custom data payload for the export with [Twig](../../../11.developer-guide/80.twig-tutorial/) templating syntax
...
#### **Synchronization**
> Available with [Synchronization](../../../03.data-exchange/03.synchronization/) module
...
<!-- TODO: enhance with real payload example -->
- **Payload**: Custom data payload for the synchronization with [Twig](../../../11.developer-guide/80.twig-tutorial/) templating syntax
...
Script mode provides advanced email configuration using [Twig](../../../11.developer-guide/80.twig-tutorial/) templating syntax. 
...
This is an action added by **Microsoft 365 Connector** module. It downloads emails from your Microsoft mailbox and saves them in **Emails** entity. For more information please read [Microsoft 365 Connector](../../../04.integration/01.microsoft-connector/docs.md) documentation page.

### Document Generation

#### **Generate PDF**
> Available with [PDF Generation](../../../08.publishing/01.pdf-generator/) module.
...
**Configuration:**
- **Error Message**: Text content for the error message (supports dynamic content with [Twig syntax](../../../11.developer-guide/80.twig-tutorial/docs.md))

This action is typically used within [Workflows](../../../05.collaboration/01.workflows/) for conditional error handling. It is usually set up with an empty **Display** field so it does not appear as an action button, and the error message is shown whenever the action is triggered in the workflow.

#### **Validate Component**

This is an action added by **Components** module. For more information please read [Components](../../../05.collaboration/06.components/docs.md) documentation page.
