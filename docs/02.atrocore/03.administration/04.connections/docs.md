...
This connection type is used by the [Import: Remote File](../../../03.data-exchange/06.import-feeds-remote-file/) module to allow importing data from remote files.
...
Following connection types are available only with [AI Integration](../../../06.pim/11.ai-integration/) module.
