...
When creating a record through the user interface, IDs are assigned automatically and cannot be set manually. However, custom IDs can be provided when creating records via [import](../../../../03.data-exchange/01.import-feeds/docs.md).
