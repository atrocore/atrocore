...
| Has Content Components                     | Enable [components](../../../05.collaboration/06.components/) for this entity                                                                                                      |
...
Versioning panel is added by [Revisions](https://store.atrocore.com/revisions/20179) module. For more information, please visit the [Revisions](../../../05.collaboration/03.revisions/docs.md) page.
