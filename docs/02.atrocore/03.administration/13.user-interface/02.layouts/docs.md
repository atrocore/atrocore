...
Additional panels may be added by modules or features. For example, if [Matching](../../../18.master-data-management/17.matching/docs.md) is enabled for this entity, the **Matched records** panel is added to the Insights tab.
...
For more information about Small Detail View, see [Understanding UI - Quick Detail View (Small Detail View)](../../../04.understanding-ui/docs.md#quick-detail-view-small-detail-view).
