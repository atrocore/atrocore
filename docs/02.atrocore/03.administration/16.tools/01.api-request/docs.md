...
The tool is particularly useful for copying [Import Feeds](../../../../03.data-exchange/01.import-feeds/) and [Export Feeds](../../../../03.data-exchange/02.export-feeds/) between different AtroCore instances.
...
For detailed information about copying feed configurations, see [Copying Feed Configurations](../../../../03.data-exchange/11.copying-feed-configurations/).
