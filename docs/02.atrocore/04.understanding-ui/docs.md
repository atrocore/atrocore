...
Users can edit records and add or delete attributes via list view using [in-line editing](../../02.atrocore/08.record-management/docs.md#in-line-editing).
...
Within the AtroPIM system the plate view is available only for [products](../../06.pim/03.products/).

## Kanban View
> Available with [Projects](../../05.collaboration/08.projects/docs.md) module. 
...
Users can edit records and add or delete attributes via small list view using [in-line editing](../../02.atrocore/08.record-management/docs.md#in-line-editing).
...
Some actions, such as **Translate** and  **Compare** are added by modules. In this case by [Translations](../../05.collaboration/04.translations) and [Synchronization](../../03.data-exchange/03.synchronization) modules.
...
If [Matching](../../02.atrocore/18.master-data-management/17.matching/docs.md) is enabled for this entity, the `Matched records` panel is added to the Insights tab.
...
Some functions, such as **Discussions** are added by modules. In this case by [Discussions](../../05.collaboration/02.discussions) module.
