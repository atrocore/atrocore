...
- **Rebuild Database**: [Updates the database structure](../../10.installation-and-maintenance/05.maintenance/docs.md#database-rebuild) to match the current metadata configuration (admin users only).
- **Update**: [System update](../../10.installation-and-maintenance/04.modules-and-updates/docs.md#module-update) functionality (admin users only)
