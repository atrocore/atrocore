...
There are [Access Management](../../02.atrocore/03.administration/14.access-management/01.users/docs.md) fiedls on the **Summary** panel:
...
Also, there are [Access Management](../../02.atrocore/03.administration/14.access-management/01.users/docs.md) fiedls on the **Summary** panel:
...
Task and appointment [Records](../../02.atrocore/08.record-management/docs.md) appear in their respective list views with sorting and filtering options. Click any record name to open its detail view.
