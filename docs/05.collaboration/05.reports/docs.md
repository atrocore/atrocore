...
Once a report has been created, you can display it on the Dashboard. To do this, create a new [Dashlet](../../02.atrocore/07.dashboards/docs.md#dashlets) of the Report type and select the desired report to display.
