...
The [Insights](../../02.atrocore/03.administration/13.user-interface/02.layouts/docs.md#insights) view group includes the following [Access Management](../../02.atrocore/03.administration/14.access-management/01.users/docs.md) fields, available on every record type (including Projects, Milestones, and Issues):
...
[Kanban view](../../02.atrocore/04.understanding-ui/docs.md#kanban-view) provides a visual board layout organized by status — useful for teams following agile workflows.
...
Project, milestone, and issue [Records](../../02.atrocore/08.record-management/docs.md) appear in their respective list views with sorting and filtering options. Click any record name to open its detail view.
