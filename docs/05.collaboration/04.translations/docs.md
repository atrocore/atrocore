...
- **Translation engine** – Select the machine translation engine to use for automated translations of [multilingual fields](../../02.atrocore/03.administration/03.languages/docs.md#multilingual-fields).
...
> Only languages configured in the system can be used in translation rules — see [Languages](../../02.atrocore/03.administration/03.languages/docs.md). If no rule exists for a destination language, the source value is copied without translation.
...
This field can be added to entity [layouts](../../02.atrocore/03.administration/13.user-interface/02.layouts/docs.md) and used for filtering. To get an overview across an entity, add the [Records by Translation Status](../../02.atrocore/07.dashboards/docs.md#records-by-translation-status) dashlet to your dashboard.
...
To update multiple records at once, select the records on the list page, click **Actions**, and choose [**Mass update**](../../02.atrocore/12.mass-actions/docs.md#mass-update).
...
If the Quality Check module is installed, you can monitor the percentage of translated or approved multilingual fields per record using the [Translation Completeness](../../02.atrocore/15.data-quality/docs.md#translation-completeness) quality check.
