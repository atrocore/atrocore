...
> If database rebuild is required, the `Rebuild Database` option will also be shown in the [User menu](../../01.atrocore/05.toolbar/index.md#user-menu) for admin users.
...
> The `Clear System cache` option is also available in the [User menu](../../01.atrocore/05.toolbar/index.md#user-menu) for admin users.
