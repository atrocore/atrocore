...
> To use this adapter [Export](../../02.data-exchange/02.export-feeds/docs.md) and [Import](../../02.data-exchange/01.import-feeds/docs.md) PIM modules are required.
...
To fetch the data from PIM, the adapter will need the code of an active [Export feed](../../02.data-exchange/02.export-feeds/docs.md#export-feed-creation).
...
To update modified data in easy catalog datasource to PIM database, you need to configure an [Import feed](../../02.data-exchange/01.import-feeds/docs.md#import-feed-creation).
...
> You can create an Import feed directly from an Export feed by using the functionality [`Duplicate as Import Feed`](../../02.data-exchange/01.import-feeds/docs.md#import-feed-actions)
...
| **Username** | PIM user with export/import [access rights](../../01.atrocore/03.administration/14.access-management/03.roles/docs.md#authorizations-and-access-levels) for the target entity | `catalog_manager` |
