...
Schedule regular imports via [Scheduled Jobs](../../01.atrocore/03.administration/05.system-jobs/01.scheduled-jobs/) to keep your AtroCore data synchronized automatically, ensuring your system always processes new files as they arrive.
...
Access files from remote servers via FTP or SFTP protocols. Requires setting up a [Connection](../../01.atrocore/03.administration/04.connections/) entity with server credentials of type [FTP](../../01.atrocore/03.administration/04.connections/docs.md#ftp) or [SFTP](../../01.atrocore/03.administration/04.connections/docs.md#sftp).
