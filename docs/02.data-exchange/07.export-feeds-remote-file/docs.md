...
Schedule regular exports via [Scheduled Jobs](../../01.atrocore/03.administration/05.system-jobs/01.scheduled-jobs/) to keep your remote destinations up to date automatically.
...
Deliver files to remote servers via FTP or SFTP protocols. Requires setting up a [Connection](../../01.atrocore/03.administration/04.connections/docs.md) entity with server credentials of type [FTP](../../01.atrocore/03.administration/04.connections/docs.md#ftp) or [SFTP](../../01.atrocore/03.administration/04.connections/docs.md#sftp).
...
- **File Name** – the name of the file to be created on the remote server. Supports [Twig syntax](../../10.developer-guide/80.twig-tutorial/docs.md) for dynamic naming (e.g., including a date or timestamp)
