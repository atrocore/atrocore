...
[Import](../01.import-feeds/index.md) and [Export](../02.export-feeds/index.md) Feeds expose REST API [endpoints](../../10.developer-guide/10.rest-api/index.md) for data exchange. Use these endpoints to integrate AtroCore with external tools, or to set up a custom REST API endpoint by configuring a data feed.
