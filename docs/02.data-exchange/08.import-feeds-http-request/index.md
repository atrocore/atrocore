...
- **URL** – the API endpoint URL. Supports [Twig syntax](../../10.developer-guide/80.twig-tutorial/index.md) for dynamic values like pagination parameters
