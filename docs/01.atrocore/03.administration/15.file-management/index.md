...
Thumbnails are not included in the default user interface layout. However, they can be added to pages through the  [Layout Management](../../03.administration/13.user-interface/02.layouts/index.md) if needed.
