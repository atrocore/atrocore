...
To enable email notifications, you also need to set up an SMTP connection. Go to `Administration / Connections` (see [Connections](../04.connections/index.md#smtp)), create a new connection of type SMTP, and then select it as "Connection for E-Mail Notifications" in the `Administration / Settings`.
