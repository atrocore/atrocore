...
To create a Many-to-One relationship, create a [Link](../02.data-types/docs.md#link) field in the [Fields panel](../docs.md#fields-panel) of the required Entity. The Relation Management panel will appear where you configure:
...
Create a [Multiple Link](../02.data-types/docs.md#multiple-link) field and select "One-to-Many" as the Relation Type. This ensures records on the "many" side can only be linked to one record on the "one" side.
...
Create a Multiple Link field and select "Many-to-Many" as the Relation Type. This automatically creates a [Relation entity](../01.entity-types/docs.md#relation) to manage the connections between records.
