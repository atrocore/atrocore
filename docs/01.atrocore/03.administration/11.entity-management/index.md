...
| Quick Actions                              | Select actions to display as icon shortcuts directly next to the three-dot button in list rows. Configured quick actions allow users to trigger the most common operations without opening the dropdown menu. Available options: View, Edit, Remove. For more information, see [Quick Actions](../../04.understanding-ui/index.md#quick-actions). |
