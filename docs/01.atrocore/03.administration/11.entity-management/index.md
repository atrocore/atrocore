...
For an entity, the following record actions are available: Delete (available only for custom entities) and Duplicate. When an entity is duplicated, all of its fields are copied as well, except for fields of the [Multiple Link](02.data-types/index.md#multiple-link) type.
...
| -------------- | --------------------------------------------------------------------------------------- |
| Type           | Type of the entity. [Base](01.entity-types/index.md#base), [Hierarchy](01.entity-types/index.md#hierarchy), [Archive](01.entity-types/index.md#archive) and [Reference](01.entity-types/index.md#reference) types are available for entities |
| Code           | Entity name                                                                             |
...
| Default order field                        | A field by which records are sorted in the list view. By default records are sorted by [ID](../11.entity-management/02.data-types/index.md#identifiers)                             |
...
| Permanent deletion period, days            | Records for this entity are permanently deleted XX days after the deletion date. This field is not used in [Relation](../../03.administration/11.entity-management/01.entity-types/index.md#relation) entity type. See [Scheduled Jobs](../05.system-jobs/01.scheduled-jobs/index.md#clear-deleted-data) for details. |
| Auto-delete period, in days                | Records that exist longer than the specified period will be deleted from the system. This field is used in [Archive](../../03.administration/11.entity-management/01.entity-types/index.md#archive) entity type. See Scheduled Jobs for details.                                                                |
...
| Text Filter fields                         | If left empty, all text fields will be used for [searching records in list views](../../11.search-and-filtering/) and [global search](../../05.toolbar/index.md#global-search). If specified, only the selected fields will be searchable for this entity. |
| Non Comparable Fields                      | Fields that should not be used for [comparison](../../09.comparison-and-merge/index.md#compare-records)                                                                             |
| Quick Actions                              | Select up to 2 actions to display as icon shortcuts directly next to the three-dot button in list rows. Configured quick actions allow users to trigger the most common operations without opening the dropdown menu. Available options: View, Edit, Remove. For more information, see [Quick Actions](../../04.understanding-ui/index.md#quick-actions). |
...
| Has Classifications                        | Enable [Classifications](../12.attribute-management/04.classifications/index.md) for this entity. See [Classifications](../12.attribute-management/04.classifications/index.md#enabling-classifications-for-an-entity) for the additional options this unlocks. |
| Disable direct attribute linking           | When enabled, [attributes](../12.attribute-management/) can only be added to records via classification and not manually. Only shown when `Has Classifications` is enabled. See [Classifications](../12.attribute-management/04.classifications/index.md#enabling-classifications-for-an-entity)                                                                                            |
| Link Attributes with the Classification automatically           | When an [attribute](../12.attribute-management/index.md) is directly linked to a record that is already assigned to a Classification, it is also automatically added to that Classification. Only available when Has Attributes is enabled and Disable direct attribute linking is disabled. See [Classifications](../12.attribute-management/04.classifications/index.md#enabling-classifications-for-an-entity) for details.                                                                                            |
| Single Classification only           | When enabled, only one [classification](../12.attribute-management/04.classifications/index.md) can be added to record. See [Classifications](../12.attribute-management/04.classifications/index.md#enabling-classifications-for-an-entity) |
...
See [Hierarchy Entity Type](../11.entity-management/01.entity-types/index.md#hierarchy) for details.
