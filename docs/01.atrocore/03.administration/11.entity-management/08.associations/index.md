...
Enable associations for an entity by activating the `Has Associates` checkbox in [Administration → Entities](../../11.entity-management/index.md#entity-configuration). This setting is available only for entities of type [Base](../01.entity-types/index.md#base) or [Hierarchy](../01.entity-types/index.md#hierarchy).
...
When associations are [activated](#activation) for an entity, two panels appear in the [details view](../../../04.understanding-ui/index.md#detail-view):
...
| **Amount**                               | The number of associated [products](../../../../05.pim/03.products/index.md). This is not displayed by default in layouts. This field only exists for product associations. It does not exist for other entities. It can be used to create product bundles.                                                                                                           |
