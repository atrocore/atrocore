...
| **Amount**                               | The number of associated [products](../../../../05.pim/03.products/docs.md). This is not displayed by default in layouts. This field only exists for product associations. It does not exist for other entities. It can be used to create product bundles.                                                                                                           |
