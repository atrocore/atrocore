...
As an example, the "Product Channels" entity links [Products](../../../../05.pim/03.products) and [Channels](../../../../05.pim/06.channels), and includes an "Active" checkbox field to control product availability per channel — demonstrating how Relation entities can store relationship-specific data.
...
New [data type `Script`](../02.data-types/docs.md#script) for attributes and fields is included in this module to enable dynamic value calculation using [Twig Templating](../../../../10.developer-guide/80.twig-tutorial). This functionality allows you to create computed values based on existing data, perform conditional logic, and reference related entity information.
