...
> Field inheritance is controlled at the field configuration level using the Uninherited option (see [Field Configuration Options](../03.fields-and-attributes/index.md#configuration-options)).
...
The [left sidebar](../../../04.understanding-ui/index.md#left-sidebar) displays the complete hierarchy tree, allowing you to navigate through parent-child relationships. This tree view shows:
...
The [detail view](../../../04.understanding-ui/index.md#left-sidebar) provides specific hierarchy information:
...
> You can discover more about using `Hierarchy` in the [Search and Filtering](../../../11.search-and-filtering/index.md#left-sidebar-search) documentation.
