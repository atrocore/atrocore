...
| Has Classifications                        | Enable [Classifications](../12.attribute-management/04.classifications/docs.md) for this entity. See [Classifications](../12.attribute-management/04.classifications/docs.md#enabling-classifications-for-an-entity) for the additional options this unlocks. |
