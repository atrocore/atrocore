...
After creating a role, open its detail view to configure permissions. Permissions in AtroCore are defined through **Scopes** — each scope sets access rules for one specific entity, such as [Products](../../../../05.pim/03.products/docs.md), [Categories](../../../../05.pim/05.categories/docs.md), or [Attributes](../../12.attribute-management/01.attributes/docs.md).
