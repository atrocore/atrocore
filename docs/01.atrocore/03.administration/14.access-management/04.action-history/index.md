...
[Open](../../../08.record-management/index.md#opening-records) a record to see detailed information about a specific action:
...
> To automatically clean up old Action History records, use the [Clear deleted data](../../05.system-jobs/01.scheduled-jobs/index.md#clear-deleted-data) scheduled job.
