...
**User Interface**:
- **Layout Profile**: Custom [layout configuration](../../13.user-interface/02.layouts/docs.md#layout-profiles) for the user's interface
...
Administrators can enforce password complexity requirements and expiration policies through the `Security` section of [System settings](../../01.system-settings/docs.md#security).
...
For detailed information about configuring roles and permissions, see [Roles](../03.roles/docs.md).
