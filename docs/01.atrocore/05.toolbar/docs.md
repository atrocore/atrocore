...
> Please consider, only the fields configured at "Text Filter Fields" for each entity will be searched through. See [Entity management](../03.administration/11.entity-management/docs.md#configuration-fields).
...
- **Rebuild Database**: [Updates the database structure](../../09.installation-and-maintenance/05.maintenance/docs.md#database-rebuild) to match the current metadata configuration (admin users only).
- **Update**: [System update](../../09.installation-and-maintenance/04.modules-and-updates/docs.md#module-update) functionality (admin users only)
