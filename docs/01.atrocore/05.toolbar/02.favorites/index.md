...
![Config Favorites](./_assets/configure-favorites.png){.large}
...
![User Profile](./_assets/user-favorites.png){.large}
...
![Layout Profile](./_assets/layout-profile-favorites.png){.large}
