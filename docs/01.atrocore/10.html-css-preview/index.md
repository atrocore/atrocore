...
![template](_assets/model.png){.large}
...
![template](_assets/view.png){.large}
...
![full-page-preview-function](_assets/full-page-preview-function.png){.large}
...
![full-page-preview-overview](_assets/full-page-preview-overview.png){.large}
...
![full-page-preview-selectboxes](_assets/full-page-preview-selectboxes.png){.large}

After reviewing all product information, you can change the product status directly on the preview page.

![full-page-preview-status](_assets/full-page-preview-status.png){.large}
