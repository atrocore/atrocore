...
The AtroCore system comes with a user-friendly configurable [interface](../03.administration/13.user-interface/index.md) that includes a number of views and panels, where **entity records** are displayed and managed.
...
- *[taskbar](../05.toolbar/index.md) (2);*
- *[breadcrumb navigation](#breadcrumb-navigation) including the page name (3);*
- *[search and filtering panel](../11.search-and-filtering/index.md) (4);*
- *records list (5).*
...
To edit the fields data on the list view page, use [in-line editing](../08.record-management/index.md#in-line-editing).

If they are allowed to edit layouts or create custom layouts, users can configure what they can see in the list view by clicking the edit button and entering [layout management](../03.administration/13.user-interface/02.layouts/index.md#list).

Users can edit records and add or delete attributes via list view using [in-line editing](../../01.atrocore/08.record-management/index.md#in-line-editing).
...
> [Deleted](../08.record-management/index.md#deleting-records) records are not accessible through the standard record view and their detailed information remains unavailable until the record is [restored](../08.record-management/index.md#restoring-records).
...
> For detailed information about editing processes and workflows, see the [Editing Records](../08.record-management/index.md#editing-records) section in Record Management.
...
> For detailed information about quick edit workflows, see the [Editing Records](../08.record-management/index.md#editing-records) section in Record Management.
...
> If a record is created or modified by an [action](../03.administration/06.actions/index.md) or [import](../../02.data-exchange/01.import-feeds/index.md), the **Created** or **Modified** field displays System < User, indicating that the operation was executed by the system on behalf of the specified user. When changes are made manually in the UI, the field displays only the user link without the System mention.
