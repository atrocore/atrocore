...
Dashboards are designed for quick navigation within the AtroCore entities data displayed on separate dashlets. The dashboard is the starting page of AtroCore that can be reached any time via clicking the [Header Logo](../05.toolbar/index.md#header-logo) located in the upper left corner of the AtroCore pages:
...
This type of dashlet is a list of [channels](../../05.pim/06.channels/) containing both active and inactive products in each channel can be displayed with this type of dashboard.
...
This type of dashlet displays a list of [import feeds](../../02.data-exchange/01.import-feeds/) that failed within a certain timeframe.
...
This type of dashlet functions in the same way, but is used for [export feeds](../../02.data-exchange/02.export-feeds/).
...
This type of dashlet displays [products](../../05.pim/03.products/) grouped by status in the form of a pie chart.
...
This dashlet displays a list of entities. The user can choose which entities to display: All, [Navigation Items](../03.administration/13.user-interface/01.navigation/index.md) or [Favourites](../../01.atrocore/05.toolbar/02.favorites/index.md).
