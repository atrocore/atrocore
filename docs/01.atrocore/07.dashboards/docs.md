...
This dashlet displays a list of entities. The user can choose which entities to display: All, [Navigation Items](../03.administration/13.user-interface/01.navigation/docs.md) or [Favourites](../../01.atrocore/05.toolbar/02.favorites/docs.md).
