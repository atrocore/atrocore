...
Clusters are created automatically by a [scheduled job](../../../01.atrocore/03.administration/05.system-jobs/01.scheduled-jobs/docs.md#create-clusters) based on the Matching Rules configured for the entity. Users cannot create clusters manually, nor can they add or remove cluster items manually.
