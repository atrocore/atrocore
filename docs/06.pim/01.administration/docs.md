...
Read [Administration](../../02.atrocore/03.administration/) section for general administration features.

Following settings are specific to PIM, available via **Administration → PIM Settings**.

![PIM Settings](./_assets/pim-settings.png){.medium}
...
Read Chapter [Required Skills](../../02.atrocore/02.getting-started/01.required-skills) to better understand which skills are required for implementing the AtroPIM software independently. If you would like to outsource the software implementation (or its parts) to AtroCore Company or our Implementation Partners, please contact us.
