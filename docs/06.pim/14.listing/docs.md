...
- [Product](../03.products/docs.md) – the source product to which the listing is linked.
- [Channel](../06.channels/docs.md) – the sales channel or platform where the product will be published.
- Status – defines the operational state of the listing (e.g., Active, Inactive, Draft).
- [Classification](../07.classifications/docs.md) – determines the attribute set associated with the listing.
