...
Saved Searches are custom filters registered in the entity `SavedSearch`, you can learn more about it in the section [Saved Filters](../../../02.atrocore/11.search-and-filtering).
