...
The ACL for any user is configured in the administration panel. For more information, refer to the documentation on [roles](../../../02.atrocore/03.administration/14.access-management/03.roles).
