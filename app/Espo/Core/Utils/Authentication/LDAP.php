...
class LDAP extends Token
{
    ...
    {
        parent::__construct($auth, $container);
        $this->utils = new LDAP\Utils($this->getConfig());
    }
    ...
    protected function getUtils(): LDAP\Utils
    {
        return $this->utils;
    }

    protected function getLdapClient(): LDAP\Client
    {
