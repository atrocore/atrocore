...
#[Route(
    path: '/LayoutProfile/{id}/updateListLayout',
    methods: [
        'POST',
    ],
    summary: 'Save list layout into a layout profile',
    description: 'Saves the list layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName'   => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `list` layout.',
                        ],
                        'layout'       => [
                            'type'  => 'array',
                            'items' => [
    ...
    responses: [
        200 => [
            'description' => 'Updated list layout',
            'content'     => [
                'application/json' => [
                    'schema' => [
                        'type'       => 'object',
...
class LayoutProfileUpdateListLayoutHandler extends AbstractHandler
{
