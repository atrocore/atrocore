...
#[Route(
    path: '/LayoutProfile/{id}/updateSummaryLayout',
    methods: [
        'POST',
    ],
    summary: 'Save summary layout into a layout profile',
    description: 'Saves the summary layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName' => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `summary` layout.',
                        ],
                        'layout'     => [
                            'type'  => 'array',
                            'items' => [
    ...
    responses: [
        200 => [
            'description' => 'Updated summary layout',
            'content'     => [
                'application/json' => [
                    'schema' => [
                        'type'       => 'object',
...
class LayoutProfileUpdateSummaryLayoutHandler extends AbstractHandler
{
