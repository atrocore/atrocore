...
#[Route(
    path: '/LayoutProfile/{id}/updateNavigationLayout',
    methods: [
        'POST',
    ],
    summary: 'Save navigation layout into a layout profile',
    description: 'Saves the navigation layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName' => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `navigation` layout.',
                        ],
                        'layout'     => [
                            'type'  => 'array',
                            'items' => [
...
class LayoutProfileUpdateNavigationLayoutHandler extends AbstractHandler
{
