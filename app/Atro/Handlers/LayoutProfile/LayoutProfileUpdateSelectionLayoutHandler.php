...
#[Route(
    path: '/LayoutProfile/{id}/updateSelectionLayout',
    methods: [
        'POST',
    ],
    summary: 'Save selection layout into a layout profile',
    description: 'Saves the selection layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName' => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `selection` layout.',
                        ],
                        'layout'     => [
                            'type'  => 'array',
                            'items' => [
    ...
    responses: [
        200 => [
            'description' => 'Updated selection layout',
            'content'     => [
                'application/json' => [
                    'schema' => [
                        'type'       => 'object',
...
class LayoutProfileUpdateSelectionLayoutHandler extends AbstractHandler
{
