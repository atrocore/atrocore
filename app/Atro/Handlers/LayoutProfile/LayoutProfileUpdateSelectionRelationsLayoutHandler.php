...
#[Route(
    path: '/LayoutProfile/{id}/updateSelectionRelationsLayout',
    methods: [
        'POST',
    ],
    summary: 'Save selection relations layout into a layout profile',
    description: 'Saves the selection relations layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName' => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `selectionRelations` layout.',
                        ],
                        'layout'     => [
                            'type'  => 'array',
                            'items' => [
    ...
    responses: [
        200 => [
            'description' => 'Updated selection relations layout',
            'content'     => [
                'application/json' => [
                    'schema' => [
                        'type'       => 'object',
...
class LayoutProfileUpdateSelectionRelationsLayoutHandler extends AbstractHandler
{
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        return new JsonResponse(
            $this->getService()->updateLayout(
                ...
                $data->entityName,
                $data->layoutName ?? 'selectionRelations',
                '',
                '',
