...
#[Route(
    path: '/LayoutProfile/{id}/updateInsightsLayout',
    methods: [
        'POST',
    ],
    summary: 'Save insights layout into a layout profile',
    description: 'Saves the insights layout configuration for a given entity into the specified layout profile.',
    tag: 'LayoutProfile',
    parameters: [
        [
            'name'        => 'id',
            ...
            'application/json' => [
                'schema' => [
                    ...
                    'properties' => [
                        ...
                        'layoutName' => [
                            'type'        => 'string',
                            'description' => 'Custom layout name from `additionalLayouts`. When omitted, saves to the default `insights` layout.',
                        ],
                        'layout'     => [
                            'type'  => 'array',
                            'items' => [
    ...
    responses: [
        200 => [
            'description' => 'Updated insights layout',
            'content'     => [
                'application/json' => [
                    'schema' => [
                        'type'       => 'object',
...
class LayoutProfileUpdateInsightsLayoutHandler extends AbstractHandler
{
