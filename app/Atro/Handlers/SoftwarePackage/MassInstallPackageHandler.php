...
#[Route(
    path: '/SoftwarePackage/installPackage',
    methods: [
        'POST',
    ],
...
class MassInstallPackageHandler extends AbstractHandler
{
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        return new BoolResponse($this->getRecordService('SoftwarePackage')->installPackage($data->ids));
    }
}