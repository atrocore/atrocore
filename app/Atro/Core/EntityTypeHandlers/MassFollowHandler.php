...
#[Route(
    path: '/{entityName}/action/massFollow',
    methods: ['POST'],
    summary: 'Mass follow stream',
    description: 'Subscribes the current user to the stream of multiple entity records.',
    tag: '{entityName}',
    parameters: [
...
class MassFollowHandler extends AbstractHandler
{
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        $result = $this->getRecordService($entityName)->massFollow($params);
