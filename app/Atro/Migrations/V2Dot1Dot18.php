...
class V2Dot1Dot18 extends Base
{
    ...
    {
        return new \DateTime('2025-10-07 08:00:00');
    }
    ...
    public function up(): void
    {
        if ($this->isPgSQL()) {
            ...
            $this->exec("ALTER TABLE classification_attribute ADD enable_conditional_read_only BOOLEAN DEFAULT 'false' NOT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD conditional_read_only TEXT DEFAULT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD enable_conditional_protected BOOLEAN DEFAULT 'false' NOT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD conditional_protected TEXT DEFAULT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD enable_conditional_visible BOOLEAN DEFAULT 'false' NOT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD conditional_visible TEXT DEFAULT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD enable_conditional_disable_options BOOLEAN DEFAULT 'false' NOT NULL;");
            $this->exec("ALTER TABLE classification_attribute ADD conditional_disable_options TEXT DEFAULT NULL;");
            $this->exec("COMMENT ON COLUMN classification_attribute.conditional_required IS '(DC2Type:jsonObject)';");
