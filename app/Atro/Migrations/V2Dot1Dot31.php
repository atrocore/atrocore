...
class V2Dot1Dot31 extends Base
{
    ...
    public function up(): void
    {
        if ($this->isPgSQL()) {
            ...
            $this->exec("CREATE TABLE matching_rule (id VARCHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL, deleted BOOLEAN DEFAULT 'false', code VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, weight INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, master_field VARCHAR(255) DEFAULT NULL, source_field VARCHAR(255) DEFAULT NULL, operator VARCHAR(255) DEFAULT NULL, matching_id VARCHAR(36) DEFAULT NULL, matching_rule_set_id VARCHAR(36) DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, modified_by_id VARCHAR(36) DEFAULT NULL, owner_user_id VARCHAR(36) DEFAULT NULL, assigned_user_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))");
            ...
            $this->exec("CREATE INDEX IDX_MATCHING_RULE_OWNER_USER_ID ON matching_rule (owner_user_id, deleted)");
            $this->exec("CREATE INDEX IDX_MATCHING_RULE_ASSIGNED_USER_ID ON matching_rule (assigned_user_id, deleted)");
            ...
            $this->exec("CREATE TABLE matching_rule (id VARCHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL, deleted TINYINT(1) DEFAULT '0', code VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, modified_at DATETIME DEFAULT NULL, weight INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, master_field VARCHAR(255) DEFAULT NULL, source_field VARCHAR(255) DEFAULT NULL, operator VARCHAR(255) DEFAULT NULL, matching_id VARCHAR(36) DEFAULT NULL, matching_rule_set_id VARCHAR(36) DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, modified_by_id VARCHAR(36) DEFAULT NULL, owner_user_id VARCHAR(36) DEFAULT NULL, assigned_user_id VARCHAR(36) DEFAULT NULL, UNIQUE INDEX UNIQ_BACFF97B77153098EB3B4E33 (code, deleted), INDEX IDX_MATCHING_RULE_MATCHING_ID (matching_id, deleted), INDEX IDX_MATCHING_RULE_MATCHING_RULE_SET_ID (matching_rule_set_id, deleted), INDEX IDX_MATCHING_RULE_CREATED_BY_ID (created_by_id, deleted), INDEX IDX_MATCHING_RULE_MODIFIED_BY_ID (modified_by_id, deleted), INDEX IDX_MATCHING_RULE_OWNER_USER_ID (owner_user_id, deleted), INDEX IDX_MATCHING_RULE_ASSIGNED_USER_ID (assigned_user_id, deleted), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB");
