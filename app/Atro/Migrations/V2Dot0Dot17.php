    ...
    public function up(): void
    {
        ...
        if ($this->isPgSQL()) {
            ...
            foreach ($this->getConfig()->get('inputLanguageList', []) as $language) {
                ...
                $langStr .= ", name_$language VARCHAR(255) DEFAULT NULL, description_$language TEXT DEFAULT NULL, tooltip_$language TEXT DEFAULT NULL";
            }

            $this->exec("CREATE TABLE attribute (id VARCHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL $langStr, deleted BOOLEAN DEFAULT 'false', created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT 'text', is_multilang BOOLEAN DEFAULT 'false' NOT NULL, pattern VARCHAR(255) DEFAULT NULL, prohibited_empty_value BOOLEAN DEFAULT 'false' NOT NULL, data TEXT DEFAULT NULL, default_unit VARCHAR(255) DEFAULT NULL, default_date VARCHAR(255) DEFAULT NULL, is_required BOOLEAN DEFAULT 'false' NOT NULL, is_read_only BOOLEAN DEFAULT 'false' NOT NULL, sort_order INT DEFAULT NULL, attribute_group_sort_order INT DEFAULT NULL, tooltip TEXT DEFAULT NULL, description TEXT DEFAULT NULL, amount_of_digits_after_comma INT DEFAULT NULL, use_disabled_textarea_in_view_mode BOOLEAN DEFAULT 'false' NOT NULL, not_null BOOLEAN DEFAULT 'false' NOT NULL, trim BOOLEAN DEFAULT 'false' NOT NULL, created_by_id VARCHAR(36) DEFAULT NULL, modified_by_id VARCHAR(36) DEFAULT NULL, attribute_group_id VARCHAR(36) DEFAULT NULL, attribute_panel_id VARCHAR(36) DEFAULT NULL, extensible_enum_id VARCHAR(36) DEFAULT NULL, entity_id VARCHAR(36) DEFAULT NULL, composite_attribute_id VARCHAR(36) DEFAULT NULL, file_type_id VARCHAR(36) DEFAULT NULL, measure_id VARCHAR(36) DEFAULT NULL, html_sanitizer_id VARCHAR(36) DEFAULT NULL, owner_user_id VARCHAR(36) DEFAULT NULL, assigned_user_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))");
            $this->exec("CREATE UNIQUE INDEX IDX_ATTRIBUTE_UNIQUE_CODE ON attribute (deleted, entity_id, code)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_CREATED_BY_ID ON attribute (created_by_id, deleted)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_MODIFIED_BY_ID ON attribute (modified_by_id, deleted)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_ATTRIBUTE_GROUP_ID ON attribute (attribute_group_id, deleted)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_EXTENSIBLE_ENUM_ID ON attribute (extensible_enum_id, deleted)");
            ...
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_MEASURE_ID ON attribute (measure_id, deleted)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_OWNER_USER_ID ON attribute (owner_user_id, deleted)");
            $this->exec("CREATE INDEX IDX_ATTRIBUTE_ASSIGNED_USER_ID ON attribute (assigned_user_id, deleted)");
            $this->exec("COMMENT ON COLUMN attribute.data IS '(DC2Type:jsonObject)'");

            $langStr = "";
            foreach ($this->getConfig()->get('inputLanguageList', []) as $language) {
                $language = strtolower($language);
                $langStr .= ", name_$language VARCHAR(255) DEFAULT NULL, description_$language TEXT DEFAULT NULL";
            }
            $this->exec("CREATE TABLE attribute_group (id VARCHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL $langStr, deleted BOOLEAN DEFAULT 'false', description TEXT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, is_active BOOLEAN DEFAULT 'true' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, sort_order INT DEFAULT 0, entity_id VARCHAR(36) DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, modified_by_id VARCHAR(36) DEFAULT NULL, owner_user_id VARCHAR(36) DEFAULT NULL, assigned_user_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))");
            ...
            foreach ($this->getConfig()->get('inputLanguageList', []) as $language) {
                $language = strtolower($language);
                $langStr .= ", name_$language VARCHAR(255) DEFAULT NULL, description_$language TEXT DEFAULT NULL, synonyms_$language TEXT DEFAULT NULL";
            }
            $this->exec("CREATE TABLE classification (id VARCHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL $langStr, deleted BOOLEAN DEFAULT 'false', description TEXT DEFAULT NULL, release VARCHAR(255) DEFAULT NULL, synonyms TEXT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, modified_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, type VARCHAR(255) DEFAULT 'general', is_active BOOLEAN DEFAULT 'false' NOT NULL, entity_id VARCHAR(36) DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, modified_by_id VARCHAR(36) DEFAULT NULL, channel_id VARCHAR(36) DEFAULT NULL, owner_user_id VARCHAR(36) DEFAULT NULL, assigned_user_id VARCHAR(36) DEFAULT NULL, PRIMARY KEY(id))");
            ...
            foreach ($this->getConfig()->get('inputLanguageList', []) as $language) {
                $language = strtolower($language);
                $this->exec("COMMENT ON COLUMN classification.synonyms_$language IS '(DC2Type:jsonArray)'");
            }
            ...
            $this->exec("ALTER TABLE role_scope ADD create_attribute_value_action VARCHAR(255) DEFAULT NULL, ADD delete_attribute_value_action VARCHAR(255) DEFAULT NULL");
        }
    }
