...
class Association extends Base
{
    ...
    protected function hasRecords(Entity $entity, bool $isActive = false): bool
    {
        ...
        $qb = $connection->createQueryBuilder()
            ...
            ->innerJoin('ar', $connection->quoteIdentifier($table), 'rm', "rm.id = ar.associating_item_id AND rm.deleted = :false")
            ->innerJoin('ar', $connection->quoteIdentifier($table), 'rr', "rr.id = ar.associated_item_id AND rr.deleted = :false")
