...
class NotificationRule extends Base
{
    ...
    public function getNotificationProfileUsers($notificationProfileId): array
    {
        ...
        if (Converter::isPgSQL($connection)) {
            ...
            $subquery = "SELECT id FROM preferences WHERE JSON_EXTRACT(data, '$.receiveNotifications') = :true AND JSON_EXTRACT(data, '$.notificationProfileId') = :notificatioProfileId";
        }
