...
class Oauth1Callback extends AbstractEntryPoint
{
    ...
    private ConnectionOauth1 $connectionOauth1;
    ...
    public function run()
    {
        ...
        $type = $_GET['type'];
        $this->connectionOauth1 = $this->container->get(ConnectionOauth1::class);
        $connectionId = $this->getServiceFactory()->create('Connection')->decryptPassword($_GET['connectionId']);
